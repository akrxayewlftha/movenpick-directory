...
const DIRECTORY = {
  ...
  categories: [
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      items: [
        { name: "Le Marcelona", tagline: "Cuisine espagnole", pid: "marcelona",
        ...
        { name: "Le Jamra", tagline: "Cuisine healthy méditerranéenne", pid: "jamra",
        ...
        { name: "Le Manso Pool", tagline: "Snacking au bord de la piscine", pid: "manso_pool",
          chips: ["12h00 – 18h00", "Espace fumeur"],
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      items: [
        { name: "Ô de Roses par Cinq Mondes", tagline: "Spa · Hammam · Soins", pid: "spa_ode",
