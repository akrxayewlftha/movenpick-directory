...
const DIRECTORY = {
  ...
  categories: [
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      items: [
        { name: "Le Marcelona", tagline: "Spanish cuisine", pid: "marcelona", sid: "cd5e4aae-55a1-459d-805f-5a1df0631800",
        ...
        { name: "Le Jamra", tagline: "Healthy Mediterranean cuisine", pid: "jamra", sid: "7966ad40-cf31-4ebc-98d4-8fcc66af580d",
        ...
        { name: "Le Manso Pool", tagline: "Poolside snacking", pid: "manso_pool", sid: "028bcea2-d925-4ce0-82e7-2b1bae8d3b5c",
          chips: ["12:00 PM – 6:00 PM", "Smoking area"],
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      items: [
        { name: "Ô de Roses by Cinq Mondes", tagline: "Spa · Hammam · Treatments", pid: "spa_ode", sid: "02f7dcd8-8cbb-4d3c-bdd4-7dd052e99e3a",
